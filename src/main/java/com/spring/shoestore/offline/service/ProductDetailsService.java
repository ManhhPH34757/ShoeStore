...
public class ProductDetailsService {
    ...
    public void saveProductDetails(Integer id, List<ProductDetailDto> productDetails) {
        for (ProductDetailDto detailDto : productDetails) {
            ProductDetail productDetail = new ProductDetail();
            productDetail.setIdProduct(productRepository.findById(id).get());
            ...
            //productDetail.setIdSale(saleRepository.findById(detailDto.getIdSale()).get());
